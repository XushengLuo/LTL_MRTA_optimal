...
\subsection{Case study \RNum{2}: Scalability}

In this case study, we examine the scalability of our proposed method with respect to the size of the environment and the number of robots, and compare the performance with the BMC-based method in~\cite{sahin2019multi}.
...
\begin{table}[!t]
  ...
  \resizebox{\linewidth}{!}{\begin{tabular}{ccccc}
      ...
      8 & 513.0$\pm$30.2 & 124.9$\pm$9.2 & 1819$\pm$149.9 & 334.9$\pm$153.9 \\
      12 & 794.6$\pm$11.1 & 187.4$\pm$9.1 &  2217.0$\pm$163.8 &  704.3$\pm$178.0\\
      16 & 1080.2$\pm$14.7 & 501.95$\pm$225.4 & 2725.8$\pm$149.2 & 1135.8$\pm$123.7\\
