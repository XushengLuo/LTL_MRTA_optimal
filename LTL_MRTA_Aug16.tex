...
\begin{figure}[t]
    ...
    \subfigure[$\auto{subtask}^-$ for task {\it (i)}]{
      \label{fig:sub-NBA}
      \includegraphics[width=0.27\linewidth]{nba_i_subtask_prune.pdf}}
    \hspace{1em}
    \subfigure[Subtasks and poset]
    {\label{fig:subtask}
      \includegraphics[width=0.6\linewidth]{subtask_i.pdf}}
...
%% \subsubsection{Case \RNum{1}}First, we consider a team of robots of 3 types, with each type including 4 robots. The LTL task captures a multi-agent traveling salesman problem (TSP)~\cite{bektas2006multiple},
%% %\vspace{-1em}
